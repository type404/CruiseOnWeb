...
namespace CruiseOnWeb.Controllers
{
    public class CruisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CruiseId,UsId,CruiseName,CruiseDepPortName,CruiseArrPortName,Cost,Duration")] Cruis cruis)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CruiseId,UsId,CruiseName,CruiseDepPortName,CruiseArrPortName,Cost,Duration")] Cruis cruis)
        {
            if (ModelState.IsValid)
            {
